...
| mysql | [Repo](https://github.com/charmed-kubernetes/juju-relation-mysql.git) | [Docs](https://github.com/charmed-kubernetes/juju-relation-mysql.git#readme) | mysql | Standard MySQL interface with generated, per-service databases |
