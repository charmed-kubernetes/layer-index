...
| nginx | [Repo](https://github.com/charmed-kubernetes/juju-layer-nginx.git) | [Docs](https://github.com/charmed-kubernetes/juju-layer-nginx.git#readme) | NGINX | NGINX layer for deploying web applications |
...
| aws-iam | [Repo](https://github.com/charmed-kubernetes/interface-aws-iam) | [Docs](https://github.com/charmed-kubernetes/interface-aws-iam#readme) | AWS-IAM | AWS-IAM interface for Kubernetes charm integration. |
...
| grafana-dashboard | [Repo](https://github.com/charmed-kubernetes/interface-grafana-dashboard) | [Docs](https://github.com/charmed-kubernetes/interface-grafana-dashboard#readme) | grafana-dashboard | Interface layer for importing dashboards into Grafana |
...
| juju-info | [Repo](https://github.com/charmed-kubernetes/interface-juju-info.git) | [Docs](https://github.com/charmed-kubernetes/interface-juju-info.git#readme) | juju-info | Implied interface for subordinates with special behavior. This is not a substitute for a proper relationship interface.  |
...
| ovsdb-cluster | [Repo](https://github.com/openstack-charmers/charm-interface-ovsdb.git) | [Docs](https://github.com/openstack-charmers/charm-interface-ovsdb/blob/master/src/ovsdb_cluster/README.md) | ovsdb-cluster | Interface for OVN OVSDB Cluster |
| ovsdb-cms | [Repo](https://github.com/openstack-charmers/charm-interface-ovsdb.git) | [Docs](https://github.com/openstack-charmers/charm-interface-ovsdb/blob/master/src/ovsdb_cms/README.md) | ovsdb-cms | Interface for a OVN CMS to talk to a OVSDB Cluster |
...
| ovsdb | [Repo](https://github.com/openstack-charmers/charm-interface-ovsdb.git) | [Docs](https://github.com/openstack-charmers/charm-interface-ovsdb/blob/master/src/ovsdb/README.md) | ovsdb | Interface for OVN consumers to talk to a OVSDB Cluster |
...
| peer-discovery | [Repo](https://github.com/charmed-kubernetes/charm-interface-peer-discovery) | [Docs](https://github.com/charmed-kubernetes/charm-interface-peer-discovery#readme) | peer-discovery | [proposal] simple interface to discover all peers of a charm through peer relation |
...
| prometheus-manual | [Repo](https://github.com/charmed-kubernetes/interface-prometheus-manual) | [Docs](https://github.com/charmed-kubernetes/interface-prometheus-manual#readme) | prometheus-manual | Interface layer for register manual scrape job configuration stanzas with Prometheus 2 |
...
| vsphere-integration | [Repo](https://github.com/charmed-kubernetes/interface-vsphere-integration.git) | [Docs](https://github.com/charmed-kubernetes/interface-vsphere-integration.git#readme) | vsphere-integration | Interface layer for connecting to the VMware vSphere integration charm |
